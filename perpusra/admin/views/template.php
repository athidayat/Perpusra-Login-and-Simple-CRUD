    ...
    <div class="container ">
        <nav class="navbar navbar-default" style="background-image: url('../assets/bg.png'); margin: 0px;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Perpustakaan Rakyat</a>
                </div>
        ...
        <div class="content" >
              <ul class="list-group col-md-3 col-xs-2">
                <li class="list-group-item "><a href="index.php?mode=buku"> <i class="fa fa-address-card "></i> <span class="hidden-xs">Koleksi Buku</span></a></li>
